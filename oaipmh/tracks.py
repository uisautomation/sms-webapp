...
def ensure_track_media_item(track):
    ...
    # the same tags list object. We make use of fetch_url to let the backend fetch the media item
    # for us.
    media_item = mpmodels.MediaItem.objects.create(
        ...
        downloadable=False, tags=list(LECTURE_CAPTURE_TAGS), fetch_url=track.url,
